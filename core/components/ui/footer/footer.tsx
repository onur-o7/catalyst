...
const Footer = ({
  ...
  return (
    <footer className={cn('bg-gray-100 pt-[60px] text-sm', className)} {...props}>
      <p className="text-center">{t('subtitle')}</p>
      <h3 className="font-display my-[23px] text-center text-2xl text-primary">{t('title')}</h3>

      <section className="flex flex-col gap-8 px-4 py-10 2xl:container sm:px-10 md:flex-row lg:gap-4 lg:px-12 2xl:mx-auto 2xl:px-0">
